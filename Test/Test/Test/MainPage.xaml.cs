...
namespace Test
{
    ...
    {
        private const string Url = "http://skillmatrixws.azurewebsites.net/api/Todo"; //This url is a free public api intended for demos
        ...
        //    // Your code here
        //    Navigation.PushAsync(new ListViewPage2(item.));
        //}
        ...
        private void Handle_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            var item = e.Item;
            // Your code here
            Navigation.PushAsync(new ListViewPage2((List)e.Item));
        }
